...
function StatItem({ stat }: { stat: Stat }) {
  ...
  return (
    <div
      ref={ref}
      className="border-l border-charcoal/10 px-3 py-8 text-center first:border-l-0 sm:py-10 min-[400px]:px-6 max-lg:odd:border-l-0 max-lg:[&:nth-child(n+3)]:border-t"
    >

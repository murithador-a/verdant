/* Minimal stroke icon set — consistent 24px grid, currentColor. */
...
export function SparkleIcon({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M12 2c.6 4.8 2.5 7.4 4.8 8.6 1.9 1 5.2 1.4 5.2 1.4s-3.3.4-5.2 1.4c-2.3 1.2-4.2 3.8-4.8 8.6-.6-4.8-2.5-7.4-4.8-8.6C5.3 12.4 2 12 2 12s3.3-.4 5.2-1.4C9.5 9.4 11.4 6.8 12 2z" />
    </svg>
  );
}
...
export function WhatsAppIcon({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      ...
      <g transform="translate(7.4 7.6) scale(0.4)">
...
export type SocialIconName = "instagram" | "tiktok" | "facebook" | "linkedin";

export function SocialIcon({ name, className = "h-[18px] w-[18px]" }: IconProps & { name: SocialIconName }) {
  if (name === "instagram") {
    return (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      ...
      <path d="M12.5 17.5V4.8c.3 2.9 2.3 5 5.7 5.4" />
    </svg>
  );
}
